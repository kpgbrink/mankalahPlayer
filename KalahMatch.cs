...
namespace Mankalah
{
    ...
    public class KalahMatch {
        ...
        private static Player pTop = new kpb23OldPlayer(Position.Top, timeLimit);	// TOP player (MAX)
        private static Player pBot = new kpb23Player(Position.Bottom, timeLimit);	// BOTTOM player	
